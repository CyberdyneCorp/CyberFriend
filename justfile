...
# Resets live messages since that day (UTC) that carry a decision marker, in
# indexed channels; the ingest backlog worker drains them. See
# docs/operations.md before running it.
# Re-extract pre-decision-log history: `just decisions-backfill --since 2026-06-01`
