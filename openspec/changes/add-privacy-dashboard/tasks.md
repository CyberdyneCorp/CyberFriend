...
- [x] 4.10 A confirmed trace deletion clears the asker id and quoted-message links, and a finished asker search is deleted (existing rows scrubbed in 0032); a person already opted out gets one button and is told they stay out; the ingest resume sweep is covered by a wiring test
